...
<div class="page-wrap">
    {{-- Phần header và nút tạo blog (giữ nguyên) --}}
    ...
    {{-- Phần lọc theo category (giữ nguyên) --}}
    <div class="card blog-tags border-0 radius-8 mt-12">
        <div class="tags">
        ...
        @if(count($blogs) > 0)
            ...
            <div class="row"> 
                @foreach ($blogs as $blog )
                    <div class="col-12 mb-3" id="blog-{{ $blog->id }}">
                        <article class="card shadow-sm border-0 h-100">
                            <div class="card-body d-flex flex-column">
                                ...
                                <div class="d-flex align-items-center mt-auto pt-3">
                                    ...
                                    {{-- Optional: Giữ lại menu edit/delete (đã được comment) --}}
                                    {{-- 
                                    <div class="dropdown ms-auto">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end">
                                            <li>
                                                <a href="{{ route('blog.edit',$blog->id) }}" class="dropdown-item"> <i class="fa fa-edit fa-fw me-1"></i> {{ get_phrase('Edit') }}</a>
                                            </li>
                                            <li>
                                                <a href="javascript:void(0)" onclick="confirmAction('{{ route('blog.delete', ['blog_id' => $blog->id]) }}', true)" class="dropdown-item text-danger"><i class="fa fa-trash fa-fw me-1"></i> {{get_phrase('Delete')}}</a>
                                            </li>
                                        </ul>
                                    </div>
                                    --}}
